...
Deno.test({
  ...
  async fn(t) {
    ...
    const InputShelfReferencesSchema = e.object({
      _id: e.optional(e.instanceOf(ObjectId, { instantiate: true })),
      shelfId: e.string(),
      quantity: e.number(),
    });

    const InputWarehouseShelfReferencesSchema = e
      .object({
    ...
    const InputWarehouseInventorySchema = e.object({
    ...
    const WarehouseInventorySchema = e
      .object({
        _id: e.optional(e.instanceOf(ObjectId, { instantiate: true })),
    ...
    type TWarehouseInventoryInput = InputDocument<
      inferInput<typeof WarehouseInventorySchema>
    >;
    type TWarehouseInventoryOutput = OutputDocument<
      inferOutput<typeof WarehouseInventorySchema>
    >;

    const WarehouseInventoryModel = Mongo.model(
      "warehouseInventory",
